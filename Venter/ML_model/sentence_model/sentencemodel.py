...
def categorizer():
    ...
    #filepaths
    responsePath = os.path.join(BASE_DIR, 'Venter/ML_model/sentence_model/data/comments/')
    categoryPath = os.path.join(BASE_DIR, 'Venter/ML_model/sentence_model/data/sentences/')
